...
client.on(`ready`, () => {	
   ...
   ///////////////////////////////
    ////////////IFCHEMPTY//////////
      ...
      client.user.setActivity(`${PREFIX}help | Bayupaguse`, { type: "STREAMING",
      url: "https://www.twitch.tv/bayupaguse"});
   
  
      }, (5000));
      ////////////////////////////////
      ////////////////////////////////
    figlet.text(`${client.user.username} Bayupaguse!`, function (err, data) {
      if (err) {
...
client.on(`message`, async (message) => {
  ...
  if(message.content.startsWith(`${prefix}embed`)){
    ...
    .setFooter("Bayupaguse", client.user.displayAvatarURL())
    //delete the Command
